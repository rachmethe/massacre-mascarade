          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a 
                ...
                className="group relative inline-flex items-center justify-center overflow-hidden rounded-lg px-6 py-3 font-black text-sm hover:text-slate-100 shadow-2xl"
              >
